        ...
        if (!errors.isEmpty()) {
            ...
            Book.find({},'title')
                .exec(function (err, books) {
                    if (err) { return next(err); }
                    // Successful, so render.
                    res.render('bookinstance_form', { title: 'Create BookInstance', book_list: books, selected_book: bookinstance.book._id , errors: errors.array(), bookinstance: bookinstance, selected_status: results.status});
            });
            return;
        }
        else {
...
exports.bookinstance_update_get = function(req, res, next) {
    ...
    async.parallel({
        bookinstance: function(callback) {
            ...
            res.render('bookinstance_form', { title: 'Update book instance', bookinstance: results.bookinstance, book: results.book});
        });
...
exports.bookinstance_update_post = [
    ...
    body('status').escape(),
    body('due_back', 'Must be a date').trim().escape(),
